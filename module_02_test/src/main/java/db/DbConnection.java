...
public class DbConnection {
    ...
    public static List<String> readDatabase(String tableNmae, String nameOfColumn1) throws
    ...
    public static List<String> readDatabase(String tableNmae, String nameOfColumn1, String nameOfColumn2, String
            nameOfColumn3) throws SQLException, ClassNotFoundException, IOException {
    ...
    public static List<String> getResultSetData(String nameOfColumn1, String nameOfColumn2, String nameOfColumn3) throws
            SQLException {
